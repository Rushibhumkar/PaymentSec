    ...
    <View style={[styles.col,styles.cont]}>
      ...
      <View style={[styles.border]}>
        <View style={[styles.row,styles.imgs]}>
          ...
          >
            <Image source={require('../../assets/images/gpay.png')} style={[styles.img,styles.gpay]} />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <Image source={require('../../assets/images/phonepe.png')} style={[styles.img,styles.phonepe]} />
          </TouchableOpacity>
          <TouchableOpacity
            // onPress={()=> Linking.openURL(`whatsapp://send?phone=+919404006892&text=Hello Hiii`)}
          >
            <Image source={require('../../assets/images/paytm.png')} style={[styles.img,styles.paytm]} />
          </TouchableOpacity>
        </View>
